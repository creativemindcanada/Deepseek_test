...
@st.cache_data(ttl=3600)  # Cache the API response for 1 hour (3600 seconds)
...
if website_url:
    api_key = st.secrets.get("google_page_speed_api")  # Retrieve API key from Streamlit secrets
